...
const mockUsers = [
	...
	{ email: 'zerocool@leetconnect.io', username: 'zero.cool', firstname: 'Zero', lastname: 'Cool', role: Role.USER, status: Status.suspended },
	...
	{ email: 'bitphantom@leetconnect.io', username: 'bit.phantom', firstname: 'Bit', lastname: 'Phantom', role: Role.USER, status: Status.suspended },
	...
	{ email: 'silentshell@leetconnect.io', username: 'silent.shell', firstname: 'Silent', lastname: 'Shell', role: Role.USER, status: Status.suspended },
	...
	{ email: 'darknet@leetconnect.io', username: 'darknet.ghost', firstname: 'Darknet', lastname: 'Ghost', role: Role.USER, status: Status.suspended },
