            ...
            <main className="flex-1 flex items-center justify-center px-6 py-20">
                <Card className="w-full max-w-md border-border/50 bg-background-elevated">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        >
                            {/* 42 Logo / Placeholder */}
                            Sign in with <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" class="w-5 h-5 ml-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19.581 16.851H24v-4.439ZM24 3.574h-4.419v4.42l-4.419 4.418v4.44h4.419v-4.44L24 7.993Zm-4.419 0h-4.419v4.42zm-6.324 8.838H4.419l8.838-8.838H8.838L0 12.412v3.595h8.838v4.419h4.419z"></path></svg>
